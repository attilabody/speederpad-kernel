/*
 * sound\sunxi-rpaf\soc\sunxi\sunxi-spdif.h
 *
...
#undef SPDIF_CLOSE_CLK_STANDBY
#else
#define SPDIF_CLOSE_CLK_STANDBY
#endif
...
struct sunxi_spdif_clk_info {
	struct clk *pll_audiox1;
	struct clk *pll_audiox4;
	struct clk *clk_module;
	struct clk *pll_audio2;
	struct clk *pll_audio2div;
