...
/**
 * @file aipu_error.c
 * Implementations of KMD error code transformation
 */
...
int map_errcode(int err)
{
    switch (err)
    {
        case AIPU_ERRCODE_NO_ERROR: return 0;
        ...
        case AIPU_ERRCODE_PLAT_GET_RES_FAIL: return -EFAULT;
        case AIPU_ERRCODE_INVALID_OPS:
        case AIPU_ERRCODE_JOB_NOT_END: return -ENOTTY;
        case AIPU_ERRCODE_INTERNAL_NULLPTR:
        case AIPU_ERRCODE_INVALID_ARGS: return -EINVAL;
        case AIPU_ERRCODE_NO_MEMORY:
        case AIPU_ERRCODE_NO_ALIGN_MEM: return -ENOMEM;
        case AIPU_ERRCODE_JOB_ID_NOT_FOUND:
        case AIPU_ERRCODE_AIPU_NOT_FOUND:
        case AIPU_ERRCODE_ITEM_NOT_FOUND:
        case AIPU_ERRCODE_JOB_DESC_UNMATCHED: return -ENOENT;
