...
#if HOST_SLEEP_PING_FILTER
	wsm_set_host_sleep_ping_filter(hw_priv, &ping_filter, 1, priv->ap_mac_addr,
			     priv->ap_ip_addr, priv->if_id);
#endif /* HOST_SLEEP_PING_FILTER */
...
#if HOST_SLEEP_PING_FILTER
	wsm_set_host_sleep_ping_filter(hw_priv, &ping_filter, 0, priv->ap_mac_addr,
			    priv->ap_ip_addr, priv->if_id);
#endif /* HOST_SLEEP_PING_FILTER */
