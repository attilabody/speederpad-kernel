...
#define FTS_DEBUG(fmt, args...) printk(KERN_ERR "[FTS][%s][%d]"fmt"\n", __func__, __LINE__, ##args)
#else
#define FTS_DEBUG(fmt, args...) printk(KERN_ERR "[FTS]"fmt"\n", ##args)
#endif

#define FTS_FUNC_ENTER() printk(KERN_ERR "[FTS][%s][%d]: Enter\n", __func__, __LINE__)
#define FTS_FUNC_EXIT()  printk(KERN_ERR "[FTS][%s][%d]: Exit\n", __func__, __LINE__)
#else
